        ...
        try {
            ...
            if (!catSnapshot.empty) {
                ...
                if (!bancosSnapshot.empty) {
                    ...
                    const saldoCorrenteAtual = parseFloat(bancoDoc.data().saldoPoupanca);
                    ...
                    await updateDoc(bancoDoc.ref, {
                        saldoPoupanca: novoSaldoCorrente,
                    });
            ...
            <div className="nav2">
                <Row className=" navCard">
                    ...
                    <Col className="mt-3 mx-5" >
                        <Link to='/RemovePoupanca' className="navCard">
                            RETIRAR
                        </Link>
                    </Col>

                    <Col className="mt-3 mx-5">
                        <Link to='/AddPoupanca' className="navCard2">
                            ADICIONAR
                        </Link>
                    </Col>
                </Row>
                ...
                <Card className="cardDespesa">
                    <Card.Body>
                        <div className="despesaPage">
                            ...
                            <p className="titleD my-2">Remover da Poupança</p>
