            ...
            <div className="nav3">
                <Row className=" navCard">
                    ...
                    <Col className="mt-3 mx-5" >
                        <Link to='/RemovePoupanca' className="navCard2">
                            RETIRAR
                        </Link>
                    </Col>

                    <Col className="mt-3 mx-5">
                        <Link to='/AddPoupanca' className="navCard">
                            ADICIONAR
                        </Link>
                    </Col>
                </Row>
                ...
                <Card className="cardDespesa">
                    <Card.Body>
                        <div className="despesaPage">
                            ...
                            <p className="title my-2">Adicionar na Poupança</p>
